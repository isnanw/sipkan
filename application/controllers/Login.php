...
class Login extends CI_Controller{
    ...
    function index(){
      $data['form_username'] = form_input('','','name="username_cgtv_122021" class="form-control form-control-xl" placeholder="Username"');
