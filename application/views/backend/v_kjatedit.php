        ...
        <div class="form-with-tabs">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <?php echo form_open('backend/Kjat/edit'); ?>
                                ...
                                <section>
                                    ...
                                    <div class="row pt-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" id="jml_petak" name="jml_petak" class="form-control" required />
                                        </div>
                                        <!--/span-->
                                    </div>
                                    <div class="row pt-3 mb-3">
                                        ...
                                        <div class="col-12">
                                            <div class="d-md-flex align-items-center mt-3">
                                                <div class="ms-auto mt-3 mt-md-0">
                                                    <a href="<?= base_url('backend/Kjat') ?>" class="btn btn-danger font-medium rounded-pill px-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#komoditas').select2();
        $.ajax({
            url: '<?= site_url() ?>backend/Kjat/ajax_edit/' + idedit,
            type: "GET",
            dataType: "JSON",
