      ...
      <form class="form-horizontal r-separator">
        <div class="card-body">
            ...
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row">
                ...
                <div class="col-sm-9">
                  ...
                  <input type="hidden" name="id_kelompok" id="id_kelompok" value="<?= $_GET['idkelompok']; ?>">
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row pt-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control border border-info" name="namapemilik" id="namapemilik"
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row pt-3">
                <label for="modalusaha" class="col-sm-3 text-end control-label col-form-label">Modal Usaha</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control border border-info" name="modalusaha" id="modalusaha"
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row pt-3">
                ...
                <div class="col-sm-9">
                  <input type="number" class="form-control border border-info" name="tahunberdiri" id="tahunberdiri"
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row pt-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control border border-info" name="provinsi" id="provinsi"
            ...
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row pt-3">
                ...
                <div class="col-sm-9">
                  <input type="number" class="form-control border border-info" name="kabupaten" id="kabupaten"
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row pt-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control border border-info" name="Kecamatan" id="Kecamatan"
            ...
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row pt-3">
                ...
                <div class="col-sm-9">
                  <input type="number" class="form-control border border-info" name="kelurahan" id="kelurahan"
              ...
              <div class="form-group mb-3 row pt-3">
                ...
                <div class="col-sm-9">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input success" type="checkbox" id="success-check" value="ktp">
                    <label class="form-check-label" for="success-check">KTP</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input success" type="checkbox" id="success-check" value="spi">
                    <label class="form-check-label" for="success-check">Sertifikat SPI</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input success" type="checkbox" id="success-check" value="spt">
                    <label class="form-check-label" for="success-check">SPT Pajak</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input success" type="checkbox" id="success-check" value="sewa">
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control border border-info" name="namaproduk" id="namaproduk"
        ...
        <div class="card-body bg-gray-200">
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row">
                <label for="" class="col-sm-12 control-label col-form-label">Tenaga Kerja Asing</label>
            ...
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row">
                <label for="" class="col-sm-12 control-label col-form-label">Tenaga Kerja Tertap</label>
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row">
                <label for="" class="col-sm-12 control-label col-form-label">Tenaga Kerja Harian</label>
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-12 row">
                <label for="jmlhharikerja" class="col-sm-3 text-end control-label col-form-label">Jumlah Hari Kerja
                  Perbulan</label>
                <div class="col-sm-9">
                  <input type="number" class="form-control border border-info" name="jmlhharikerja" id="jmlhharikerja"
                    placeholder="0" />
                </div>
              </div>
            </div>
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-3 row">
                <label for="jmlhshift" class="col-sm-3 text-end control-label col-form-label">Jumlah
                  Shift Perhari</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control border border-info" name="jmlhshift" id="jmlhshift"
                    placeholder="0" />
                </div>
              </div>
            </div>
        ...
        <div class="card-body bg-gray-200">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
              <div class="form-group mb-12 row">
                <label for="catatan" class="col-sm-3 text-end control-label col-form-label">Catatan</label>
                <div class="col-sm-9">
                  <textarea type="text" class="form-control border border-info" name="catatan"
                    id="catatan" placeholder="Informasi Lainnya"></textarea>
                </div>
              </div>
            </div>
            <!-- <div class="col-sm-12 col-lg-6">
