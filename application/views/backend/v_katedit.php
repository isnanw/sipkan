                                ...
                                <section>
                                    <div class="row pt-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" id="id_kat" name="id_kat" class="form-control border border-info" value="<?= $id_kat; ?>"
                                                required />
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                    ...
                                    <div class="row pt-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control border border-info" id="kolam" name="kolam" required>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
