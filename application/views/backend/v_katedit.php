        ...
        <div class="form-with-tabs">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <?php echo form_open('backend/Kat/edit'); ?>
                                ...
                                <section>
                                    <div class="row pt-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" id="id_kat" name="id_kat" class="form-control" value="<?= $id_kat; ?>" required />
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                    ...
                                    <div class="row pt-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" id="jml_kolam" name="jml_kolam" class="form-control" required />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="control-label">Ukuran Kolam(M<sup>2</sup>)</label>
                                            <div class="row col">
                                                <div class="col-md-3">
                                                    <input type="number" id="uk_kolam1" name="uk_kolam1" class="form-control" required />
                                                </div>
                                                <div class="col-md-1">
                                                    <label class="form-control" style="border:none; padding-top: 8px;">X</label>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="number" id="uk_kolam2" name="uk_kolam2" class="form-control" required />
                                                </div>
                                                <div class="col-md-1">
                                                    <label class="form-control" style="border:none; padding-top: 8px;">=</label>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" id="uk_kolamhasil" name="uk_kolamhasil" class="form-control" readonly />
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        ...
                                        <div class="col-12">
                                            <div class="d-md-flex align-items-center mt-3">
                                                <div class="ms-auto mt-3 mt-md-0">
                                                    <a href="<?= base_url('backend/Kat') ?>" class="btn btn-danger font-medium rounded-pill px-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#kolam').select2();
        $.ajax({
            url: '<?= site_url() ?>backend/Kat/ajax_edit/' + id_kat,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                ...
                var $hasilkolam = $("<option selected='selected'></option>").val(data.id_jeniskolam).text(data.namajeniskolam)
                $("#kolam").append($hasilkolam).trigger('change');

                $('#ketua').val(data.ketua);
                $('#jml_anggota').val(data.jml_anggota);
                $('#jml_kolam').val(data.jml_kolam);
                $('#uk_kolam1').val(data.uk_kolam1);
                $('#uk_kolam2').val(data.uk_kolam2);
                $('#uk_kolamhasil').val(data.uk_kolam1*data.uk_kolam2 + " m2");
        ...
        $("#kolam").select2({
            ajax: {
                url: '<?= site_url() ?>backend/Jeniskolam/getdatakolam',
                type: "post",
                dataType: 'json',
                delay: 200,
