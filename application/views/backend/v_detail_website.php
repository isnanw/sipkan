                ...
                <div class="card-body">
                    <div class="row" id="basic-form">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control detail_email" name="email" placeholder="Email">

                        </div>
                        <div class="col-sm-6">
                            <label for="invalid-state">Nama Kontak</label>
                            <input type="text" class="form-control detail_nama_kontak" name="nama_kontak" placeholder="Nama Kontak">

                        </div>
                        <div class="col-sm-6">
                            <label for="invalid-state">Nomor Telepon</label>
                            <input type="text" class="form-control detail_notelp" name="notelp" placeholder="No. Telp">
