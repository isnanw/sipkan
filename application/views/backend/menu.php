...
<head>
  ...
  <!-- Owl Carousel  -->
  <link rel="stylesheet"
    href="<?= base_url('assets/keren/'); ?>dist/libs/owl.carousel/dist/assets/owl.carousel.min.css">
  <link rel="stylesheet" href="<?php echo base_url('assets/'); ?>select2/css/select2.min.css">
  <link rel="stylesheet" href="<?php echo base_url('assets/'); ?>select2-bootstrap4-theme/select2-bootstrap4.min.css">

  <link rel="stylesheet"
    href="<?= base_url('assets/keren/'); ?>dist/libs/datatables.net-bs5/css/dataTables.bootstrap5.min.css">
  <!-- Core Css -->
  <link id="themeColors" rel="stylesheet" href="<?= base_url('assets/keren/'); ?>dist/css/style.min.css" />

  <link href="<?php echo base_url() . 'assets/extensions/toastify-js/src/toastify.css' ?>" type="text/css"
    rel="stylesheet" />
  <link href="<?php echo base_url() . 'assets/extensions/sweetalert2/sweetalert2.min.css' ?>" type="text/css"
    rel="stylesheet" />
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="#" class="text-nowrap logo-img fs-5 fw-bolder">
            <img src="<?= base_url('assets/keren/'); ?>dist/images/logos/icon.png" class="dark-logo" width="50"
              alt="" />
            <img src="<?= base_url('assets/keren/'); ?>dist/images/logos/icon.png" class="light-logo" width="50"
              alt="" /> <?= $site_title; ?>
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item <?= $this->uri->segment(2) == 'dashboard' ? 'selected' : '' ?>">
              <a class="sidebar-link <?= $this->uri->segment(2) == 'dashboard' ? 'active' : '' ?>"
                href="<?= site_url('backend/dashboard'); ?>" aria-expanded="false">
                <span>
        ...
        <div class="fixed-profile p-3 bg-light-secondary rounded sidebar-ad mt-3">
          <div class="hstack gap-3">
            ...
            <a href="<?= site_url('logout'); ?>"><button class="border-0 bg-transparent text-primary ms-auto" tabindex="0"
    ...
    <div class="body-wrapper">
      ...
      <header class="app-header">
        <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <button class="navbar-toggler p-0 border-0 collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown"
                    ...
                    <div class="d-flex align-items-center">
                      <div class="user-profile-img">
                        <img
                          src="<?= base_url() . 'assets/images/profilusers/' . $this->session->userdata('user_photo'); ?>"
                      ...
                      <div class="message-body">
                        <a href="<?= site_url('backend/profil'); ?>" class="py-8 px-7 mt-8 d-flex align-items-center">
                          <span class="d-flex align-items-center justify-content-center bg-light rounded-1 p-6">
                            <img
                              src="<?= base_url() . 'assets/images/profilusers/' . $this->session->userdata('user_photo'); ?>" alt="" width="24"
                              height="24">
                          </span>
