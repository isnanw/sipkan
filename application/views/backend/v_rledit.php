        ...
        <div class="form-with-tabs">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <?php echo form_open('backend/Rl/edit'); ?>
                                ...
                                <section>
                                    ...
                                    <div class="row pt-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" id="jml_longline" name="jml_longline" class="form-control border border-info" required />
                                        </div>
                                        <!--/span-->
                                    </div>
                                    <div class="row pt-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" id="potensi" name="potensi" class="form-control border border-info" required />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="control-label">Existing (M<sup>2</sup>)</label>
                                            <input type="number" id="existing" name="existing" class="form-control border border-info" required />
                                        </div>
                                        <!--/span-->
                                    </div>
                                    <div class="row pt-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" id="jml_bibit" name="jml_bibit" class="form-control border border-info" required />
                                        </div>
                                        <!--/span-->
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#komoditas').select2();
        $.ajax({
            url: '<?= site_url() ?>backend/Rl/ajax_edit/' + idedit,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                ...
                $('#jml_longline').val(data.jml_longline);
                $('#potensi').val(data.potensi);
                $('#existing').val(data.existing);
                $('#jml_bibit').val(data.jml_bibit);
