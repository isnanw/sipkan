                    ...
                    <div class="modal-body form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <div class="form-group" id="lineatasan">
                                    <label for="valid-state">Atasan</label>
                                    <select class="form-select atasan" name="atasan" id="atasan" style="width:100%">
                                            <option value="0">[Pilih Atasan]</option>
                                            <?php foreach ($atasan->result() as $row) : ?>
                                                <option value="<?php echo $row->id_atasan;?>"><?php echo $row->namaatasan;?></option>
                                            <?php endforeach;?>
                                    </select>
                                    <span class="help-block text-danger"></span>
                                    <span class="text-primary">Jika Tipe User sebagai <b>Pegawai atau Direktur</b> maka <b>Form Atasan</b> harus di isi</span>
                                </div>
