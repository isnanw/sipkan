<!-- MODAL -->
<!-- Add Records Modal -->
<div class="modal fade text-left" id="modal_form_bagian" tabindex="-1" bagian="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" bagian="document">
        <div class="modal-content">
            ...
            <div class="modal-body formbagian">
                <?php
                    $attributes = array('class' => 'form-horizontal', 'id' => 'formbagian');
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                <label for="valid-state">Bagian</label>
                                <input type="text" name="namabagian" class="form-control namabagian" id="namabagian" placeholder="Nama Bagian">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success ml-1 btnSave" id="btnSave" onclick="addbagian()">
...
<!-- Import Modal -->
                                <form id="add-row-form" action="<?php echo site_url('backend/konsumen/import');?>" method="post" enctype="multipart/form-data">
                                        <div class="modal fade text-left" id="import" tabindex="-1" bagian="dialog"
