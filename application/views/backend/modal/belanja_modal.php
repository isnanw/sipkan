<!-- MODAL -->
<!-- Add Records Modal -->
<div class="modal fade text-left" id="modal_form_belanja" tabindex="-1" belanja="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" belanja="document">
        <div class="modal-content">
            ...
            <div class="modal-body formbelanja">
                <?php
                    $attributes = array('class' => 'form-horizontal', 'id' => 'formbelanja');
                    echo form_open($this->uri->uri_string(), $attributes);
                ?>
                <div class="form-body">
                    <div class="row">
                        <input type="hidden" name="id" class="id"/>
                        <input type="hidden" name="bon" class="bon" value="<?= $_GET['bon']; ?>"/>
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                <label for="valid-state">Item Belanja</label>
                                <input type="text" name="namabelanja" class="form-control namabelanja" id="namabelanja" placeholder="Nama belanja">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="biaya" class="form-control biaya" id="biaya" placeholder="biaya Belanja">
                                <span class="help-block text-danger"></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success ml-1 btnSave" id="btnSave" onclick="addbelanja()">
...
<!-- Import Modal -->
                                <form id="add-row-form" action="<?php echo site_url('backend/konsumen/import');?>" method="post" enctype="multipart/form-data">
                                        <div class="modal fade text-left" id="import" tabindex="-1" belanja="dialog"
