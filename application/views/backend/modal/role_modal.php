<!-- MODAL -->
<!-- Add Records Modal -->
<div class="modal fade text-left" id="modal_form_role" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body formrole">
                <?php
                    $attributes = array('class' => 'form-horizontal', 'id' => 'formrole');
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="namarole" class="form-control namarole" id="namarole" placeholder="Nama Role">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success ml-1 btnSave" id="btnSave" onclick="addrole()">
