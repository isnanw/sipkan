<!-- MODAL -->
<!-- Add Records Modal -->
<div class="modal fade text-left" id="modal_form_jeniskomoditas" tabindex="-1" jeniskolam="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" jeniskolam="document">
        <div class="modal-content">
            ...
            <div class="modal-body formjeniskomoditas">
                <?php
                $attributes = array('class' => 'form-horizontal', 'id' => 'formjeniskomoditas');
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                <label for="valid-state">Jenis Komoditas</label>
                                <input type="text" name="namajeniskomoditas" class="form-control namajeniskomoditas" id="namajeniskomoditas" placeholder="Nama Jenis Komoditas">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success ml-1 btnSave" id="btnSave" onclick="addjeniskomoditas()">
