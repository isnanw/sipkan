...
$(document).ready(function() {
    ...
    table = $('#mytable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('backend/pettycashmerahmanajer/get_ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
...
function edit_pettycashmerahmanajer(id_pettycash)
{
    save_method = 'update';
    $('#formpettycash')[0].reset();
    $('.form-group').removeClass('has-error');
    ...
    $.ajax({
        url : "<?php echo site_url('backend/pettycashmerahmanajer/ajax_edit/')?>/" + id_pettycash,
        type: "GET",
        dataType: "JSON",
...
function addpettycash()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('backend/pettycashmerahmanajer/add')?>";
    } else {
        url = "<?php echo site_url('backend/pettycashmerahmanajer/edit')?>";
    }
...
$(document).on("click", "#del", function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "post",
                    url : "<?php echo site_url('backend/pettycashmerahmanajer/delete')?>",
                    data: {
                        id: id,
                    },
                    dataType: "json",
