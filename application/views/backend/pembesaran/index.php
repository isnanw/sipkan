            ...
            <div class="card">
                <div class="card-body">
                    <div class="btn-group mb-3  float-end" role="group" aria-label="Basic example">
                        <a href="<?= base_url('backend/pembesaran/v_input') ?>" class="btn icon btn-sm btn-success" id="btn-input"><i class="ti ti-square-plus"></i></a>
                    </div>
                    <br /><br />
                        ...
                        <table id="mytable" class="table table-bordered mb-0 text-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-2">Jenis Budidaya</th>
                                    <th class="col-2">Jenis Ikan</th>
...
<script type="application/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#mytable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('backend/pembesaran/get_ajax_list') ?>",
                "type": "POST",
                "data": function(data) {},
            },
    ...
    $(document).on("click", "#deletets", function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "post",
                    url: "<?php echo site_url('backend/pembesaran/deletets') ?>",
                    data: {
                        id: id,
                    },
                    dataType: "json",
