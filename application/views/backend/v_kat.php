            ...
            <div class="card">
                <div class="card-body">
                    <div class="btn-group mb-3  float-end" role="group" aria-label="Basic example">
                        <a href="<?= base_url('backend/kat/v_input') ?>" class="btn icon btn-sm btn-success" id="btn-input"><i class="ti ti-square-plus"></i></a>
                    </div>
                    <br /><br />
...
<script type="application/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#mytable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('backend/kat/get_ajax_list') ?>",
                "type": "POST",
                "data": function(data) {},
            },
    ...
    $(document).on("click", "#deletets", function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "post",
                    url: "<?php echo site_url('backend/kat/deletets') ?>",
                    data: {
                        id_kat: id_kat,
                    },
                    dataType: "json",
