...
$(document).ready(function() {
    ...
    table = $('#mytable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('backend/pettycash/get_ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
...
function edit_pettycash(id_pettycash)
{
    ...
    var base_url = '<?php echo base_url(); ?>';
    $.ajax({
        url : "<?php echo site_url('backend/pettycash/ajax_edit/')?>/" + id_pettycash,
        type: "GET",
        dataType: "JSON",
...
function addpettycash()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('backend/pettycash/add')?>";
    } else {
        url = "<?php echo site_url('backend/pettycash/edit')?>";
    }
...
$(document).on("click", "#del", function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "post",
                    url : "<?php echo site_url('backend/pettycash/delete')?>",
                    data: {
                        id: id,
                    },
                    dataType: "json",
