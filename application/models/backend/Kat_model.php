...
class Kat_model extends CI_Model
{
    ...
    {
        $query = "(SELECT ts.id,l.lokasi,l2.lokasi as kampung,ts.ketua,ts.jml_anggota,ts.jenis_kolam,ts.jml_kolam,uk_kolam1,uk_kolam2,ts.potensi1,ts.potensi2,ts.existing1,ts.existing2,j.namajeniskomoditas,ts.jml_ekor,jk.namajeniskolam
                    FROM tb_kat ts
